...
m2_a = m2.append(int(input('input nilai matrix kedua index 1,1:')))
m2_b = m2.append(int(input('input nilai matrix kedua index 1,2:')))
m2_c = m2.append(int(input('input nilai matrix kedua index 2,1:')))
m2_d = m2.append(int(input('input nilai matrix kedua index 2,2:')))
